	...
	<body  data-target=".navbar-spy" data-spy="scroll" data-offset="150">
		...
		<article class="center">
			...
			<div class="check__form">
				...
				<input type="checkbox" id="check_read" name="check_read" ><label><p>請閱讀 &nbsp; <a href="庫點子文創資訊產業有限公司攻頂計畫雲端解決方案買賣契約附約_110-08-20.pdf" target="_blank">附約</a>&nbsp; 內容後勾選同意</p></label><br>
				<input type="checkbox" id="check_agree" name="check_agree" ><label><p class="consent_btn">確認註冊，即視為您已閱讀並同意本同意書</p></label>
