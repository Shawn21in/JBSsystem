  ...
  <nav role="navigation" class="navbar-spy">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-example">
        <li class="intro_btn bttn"><a href="index.php#intro"><p>功能介紹</p></a></li>
        <li class="program_btn bttn"><a href="index.php#program"><p>方案介紹</p></a></li>
        <li class="download_btn bttn"><a href="index.php#download"><p>下載安裝及教學</p></a></li>
        
        <?php if($mlogin_TF){ ?>
        	<li class=""><a href="member_edit.php"><p>會員中心</p></a></li>
        <?php }else{ ?>
        	<li class=""><a href="register.php"><p>直接購買成為會員</p></a></li><!--register.php-->
        	<li class=""><a href="login.php"><p>管理會員登入</p></a></li>
        <?php } ?>
        <!-- 
