...
*/
 ...
 if( $wdth < 855){
   $('.intro_btn').click(function(){ $('html,body').animate({scrollTop:$('#intro').offset().top-87},1000); }); 
  $('.program_btn').click(function(){ $('html,body').animate({scrollTop:$('#program').offset().top-87},1000); });
  $('.download_btn').click(function(){ $('html,body').animate({scrollTop:$('#download').offset().top-87},1000); }); 
  $('.pay_btn').click(function(){ $('html,body').animate({scrollTop:$('#pay').offset().top-87},2000); }); 
   }  
   else{
	    
  $('.intro_btn').click(function(){ $('html,body').animate({scrollTop:$('#intro').offset().top-107},1000); }); 
  $('.program_btn').click(function(){ $('html,body').animate({scrollTop:$('#program').offset().top-107},1000); });
  $('.download_btn').click(function(){ $('html,body').animate({scrollTop:$('#download').offset().top-107},1000); }); 
  $('.pay_btn').click(function(){ $('html,body').animate({scrollTop:$('#pay').offset().top-107},2000); }); 
