...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  `taxmny` decimal(19,4) DEFAULT NULL COMMENT '扣繳稅額',
  `standardday` decimal(19,4) DEFAULT NULL COMMENT '基準天數',
  ...
  `selflmoney` decimal(19,4) DEFAULT NULL COMMENT '勞保-自付金額',
  `selftmoney` decimal(19,4) DEFAULT NULL COMMENT '勞退-自付金額',
  `selfhmoney` decimal(19,4) DEFAULT NULL COMMENT '健保-自付金額',
  `selftrate` decimal(19,4) DEFAULT NULL COMMENT '勞退比例',
  `insuredsum` decimal(19,4) DEFAULT NULL COMMENT '健保眷屬人數',
  `insuredmny` decimal(19,4) DEFAULT NULL COMMENT '健保眷屬-自付金額',
  `tuixiuselfmny` decimal(19,4) DEFAULT NULL COMMENT '雇主負擔比例',
...
(620, '2024-03-07 08:52:00', '', '', '', 'UPDATE web_company SET `Company_PW` = \'767f2e385cba483c5e3a0f41d9d78cc3\',`Company_RePwd` = \'\',`Company_Is_RePwd` = \'0\'  WHERE (BINARY Company_Acc = \'JBS123\' OR BINARY Company_Email = \'JBS123\') AND (BINARY Company_PW = \'767f2e385cba483c5e3a0f41d9d78cc3\' OR BINARY Company_RePwd = \'767f2e385cba483c5e3a0f41d9d78cc3\');', 'UPDATE', '/jp/web_post.php'),
(621, '2024-03-07 14:12:47', '', '', 'Unknown column \'cono\' in \'field list\'', 'INSERT INTO employee (`cono`,`coname1`,`employno`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`attendanceno`,`workday`,`workday2`,`expireday`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'\',\'張先生\',\'A001\',\'A12345678\',\'ZHANG,XIAN-SHENG\',\'on\',\'on\',\'A\',\'台灣\',\'台中市\',\'871208\',\'19981208\',\'gmail@gmail.com\',\'407台中市西屯區中工二路120號\',\'0912345678\',\'0412345678\',\'0912345678\',\'WD\',\'網設部\',\'BE\',\'後端工程師\',\'G\',\'800101\',\'19910101\',\'800101\',\'張太太\',\'妻子\',\'0912345678\',\'0912345678\',\'407台中市西屯區中工二路120號\',\'programming\',\'407台中市西屯區中工二路120號\',\'407台中市西屯區中工二路120號\',\'1130307\',\'20240307\');', 'ERROR', '/jp/web_post.php'),
(622, '2024-03-07 14:13:02', '', '', '', 'UPDATE sys_admin SET `Admin_Code` = \'d4327847777ca451b2f5bc661cfc53e2\',`Admin_LastLogin` = NOW(),`Admin_IP` = \'61.218.134.131\'  WHERE Admin_ID = \'1\';', 'UPDATE', '/jp/system/post/SPOST_Login.php'),
(623, '2024-03-07 14:19:26', '系統管理員', '1', 'Unknown column \'employno\' in \'field list\'', 'INSERT INTO employee (`cono`,`coname1`,`employno`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`attendanceno`,`workday`,`workday2`,`expireday`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'\',\'張先生\',\'A001\',\'A12345678\',\'ZHANG,XIAN-SHENG\',\'on\',\'on\',\'A\',\'台灣\',\'台中市\',\'871208\',\'19981208\',\'gmail@gmail.com\',\'407台中市西屯區中工二路120號\',\'0912345678\',\'0412345678\',\'0912345678\',\'WD\',\'網設部\',\'BE\',\'後端工程師\',\'G\',\'800101\',\'19910101\',\'800101\',\'張太太\',\'妻子\',\'0912345678\',\'0912345678\',\'407台中市西屯區中工二路120號\',\'programming\',\'407台中市西屯區中工二路120號\',\'407台中市西屯區中工二路120號\',\'1130307\',\'20240307\');', 'ERROR', '/jp/web_post.php'),
(624, '2024-03-07 14:20:10', '系統管理員', '1', 'Unknown column \'attendanceno\' in \'field list\'', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`attendanceno`,`workday`,`workday2`,`expireday`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'A001\',\'張先生\',\'A001\',\'A12345678\',\'ZHANG,XIAN-SHENG\',\'on\',\'on\',\'A\',\'台灣\',\'台中市\',\'871208\',\'19981208\',\'gmail@gmail.com\',\'407台中市西屯區中工二路120號\',\'0912345678\',\'0412345678\',\'0912345678\',\'WD\',\'網設部\',\'BE\',\'後端工程師\',\'G\',\'800101\',\'19910101\',\'800101\',\'張太太\',\'妻子\',\'0912345678\',\'0912345678\',\'407台中市西屯區中工二路120號\',\'programming\',\'407台中市西屯區中工二路120號\',\'407台中市西屯區中工二路120號\',\'1130307\',\'20240307\');', 'ERROR', '/jp/web_post.php'),
(625, '2024-03-07 14:44:01', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'A001\',\'張先生\',\'TE11\',\'A12345678\',\'ZHANG,XIAN-SHENG\',\'女\',\'未\',\'B\',\'台灣\',\'台中市\',\'891122\',\'20001122\',\'gmail@gmail.com\',\'407台中市西屯區中工二路120號\',\'0412345678\',\'0412345678\',\'0912345678\',\'WD\',\'網設部\',\'BE\',\'後端工程師\',\'G\',\'G1\',\'800117\',\'19910117\',\'800122\',\'張太太\',\'妻子\',\'0912345678\',\'0912345678\',\'407台中市西屯區中工二路120號\',\'eat\',\'407台中市西屯區中工二路120號\',\'407台中市西屯區中工二路120號\',\'1130307\',\'20240307\');', 'INSERT', '/jp/web_post.php'),
(626, '2024-03-07 14:45:18', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'A001\',\'張先生\',\'TE11\',\'A12345678\',\'ZHANG,XIAN-SHENG\',\'女\',\'未\',\'B\',\'台灣\',\'台中市\',\'891122\',\'20001122\',\'gmail@gmail.com\',\'407台中市西屯區中工二路120號\',\'0412345678\',\'0412345678\',\'0912345678\',\'WD\',\'網設部\',\'BE\',\'後端工程師\',\'G\',\'G1\',\'800117\',\'19910117\',\'800122\',\'19910122\',\'張太太\',\'妻子\',\'0912345678\',\'0912345678\',\'407台中市西屯區中工二路120號\',\'eat\',\'407台中市西屯區中工二路120號\',\'407台中市西屯區中工二路120號\',\'1130307\',\'20240307\');', 'INSERT', '/jp/web_post.php'),
(627, '2024-03-07 14:46:33', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'A002\',\'張先生\',\'TE111\',\'A12345678\',\'ZHANG,XIAN-SHENG\',\'女\',\'未\',\'B\',\'台灣\',\'台中市\',\'891122\',\'20001122\',\'gmail@gmail.com\',\'407台中市西屯區中工二路120號\',\'0412345678\',\'0412345678\',\'0912345678\',\'WD\',\'網設部\',\'BE\',\'後端工程師\',\'G\',\'G1\',\'800117\',\'19910117\',\'800122\',\'19910122\',\'張太太\',\'妻子\',\'0912345678\',\'0912345678\',\'407台中市西屯區中工二路120號\',\'eat\',\'407台中市西屯區中工二路120號\',\'407台中市西屯區中工二路120號\',\'1130307\',\'20240307\');', 'INSERT', '/jp/web_post.php'),
(628, '2024-03-07 14:54:11', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'A002\',\'張先生\',\'TE111\',\'A12345678\',\'ZHANG,XIAN-SHENG\',\'女\',\'未\',\'B\',\'台灣\',\'台中市\',\'891122\',\'20001122\',\'gmail@gmail.com\',\'407台中市西屯區中工二路120號\',\'0412345678\',\'0412345678\',\'0912345678\',\'WD\',\'網設部\',\'BE\',\'後端工程師\',\'G\',\'G1\',\'800117\',\'19910117\',\'800122\',\'19910122\',\'張太太\',\'妻子\',\'0912345678\',\'0912345678\',\'407台中市西屯區中工二路120號\',\'eat\',\'407台中市西屯區中工二路120號\',\'407台中市西屯區中工二路120號\',\'1130307\',\'20240307\');', 'INSERT', '/jp/web_post.php'),
(629, '2024-03-07 15:24:05', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'B111\',\'321\',\'TEST\',\'123\',\'\',\'男\',\'未\',\'O\',\'\',\'\',\'800101\',\'19910101\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'800101\',\'19910101\',\'800101\',\'19910101\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'1130307\',\'20240307\');', 'INSERT', '/jp/web_post.php'),
(630, '2024-03-07 15:25:12', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'B111\',\'321\',\'TEST\',\'123\',\'\',\'男\',\'未\',\'O\',\'\',\'\',\'800101\',\'19910101\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'800101\',\'19910101\',\'\',\'19110000\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'1130307\',\'20240307\');', 'INSERT', '/jp/web_post.php'),
(631, '2024-03-07 16:13:01', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'B111\',\'張先生\',\'TEST\',\'A12345678\',\'ZHANG,XIAN-SHENG\',\'女\',\'未\',\'A\',\'台灣\',\'台中市\',\'80-01-16\',\'1991-01-16\',\'gmail@gmail.com\',\'台中市西屯區中工二路120號\',\'\',\'\',\'\',\'WD\',\'網設部\',\'BE\',\'後端工程師\',\'B\',\'B1\',\'80-01-01\',\'1991-01-01\',\'\',\'1911--\',\'張太太\',\'妻子\',\'0912345678\',\'0912345678\',\'台中市西屯區中工二路120號\',\'test\',\'台中市西屯區中工二路120號\',\'台中市西屯區中工二路120號\',\'11303-07\',\'2024-03-07\');', 'INSERT', '/jp/web_post.php'),
(632, '2024-03-07 16:13:16', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'B111\',\'張先生\',\'TEST\',\'A12345678\',\'ZHANG,XIAN-SHENG\',\'女\',\'未\',\'A\',\'台灣\',\'台中市\',\'80-01-16\',\'1991-01-16\',\'gmail@gmail.com\',\'台中市西屯區中工二路120號\',\'\',\'\',\'\',\'WD\',\'網設部\',\'BE\',\'後端工程師\',\'B\',\'B1\',\'80-01-01\',\'1991-01-01\',\'\',\'1911--\',\'張太太\',\'妻子\',\'0912345678\',\'0912345678\',\'台中市西屯區中工二路120號\',\'test\',\'台中市西屯區中工二路120號\',\'台中市西屯區中工二路120號\',\'11303-07\',\'2024-03-07\');', 'INSERT', '/jp/web_post.php'),
(633, '2024-03-07 16:29:26', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'B111\',`employname` = \'張先生\',`no` = \'TEST\',`id` = \'A12345678\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'女\',`marry` = \'未\',`blood` = \'A\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-16\',`bornday2` = \'1991-01-16\',`email` = \'gmail@gmail.com\',`address` = \'台中市西屯區中工二路120號\',`tel` = \'\',`fax` = \'\',`mphone` = \'\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'B\',`presentname` = \'B1\',`workday` = \'85-01-01\',`workday2` = \'1996-01-01\',`expireday` = \'\',`expireday2` = \'1911--\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'台中市西屯區中工二路120號\',`add2` = \'台中市西屯區中工二路120號\',`buildday` = \'11303-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'3\';', 'UPDATE', '/jp/web_post.php'),
(634, '2024-03-07 16:30:22', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'B111\',`employname` = \'張先生\',`no` = \'TEST\',`id` = \'A12345678\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'女\',`marry` = \'未\',`blood` = \'A\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-16\',`bornday2` = \'1991-01-16\',`email` = \'gmail@gmail.com\',`address` = \'台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'B\',`presentname` = \'B1\',`workday` = \'85-01-01\',`workday2` = \'1996-01-01\',`expireday` = \'80-01-01\',`expireday2` = \'1991-01-01\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'台中市西屯區中工二路120號\',`add2` = \'台中市西屯區中工二路120號\',`buildday` = \'11303-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'3\';', 'UPDATE', '/jp/web_post.php'),
(635, '2024-03-07 16:30:40', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'B1113\',`employname` = \'張先生\',`no` = \'TEST4\',`id` = \'A12345678\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'女\',`marry` = \'未\',`blood` = \'A\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-16\',`bornday2` = \'1991-01-16\',`email` = \'gmail@gmail.com\',`address` = \'台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'B\',`presentname` = \'B1\',`workday` = \'85-01-01\',`workday2` = \'1996-01-01\',`expireday` = \'80-01-01\',`expireday2` = \'1991-01-01\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'台中市西屯區中工二路120號\',`add2` = \'台中市西屯區中工二路120號\',`buildday` = \'11303-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'3\';', 'UPDATE', '/jp/web_post.php'),
(636, '2024-03-07 16:30:45', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'B111\',`employname` = \'張先生\',`no` = \'TEST\',`id` = \'A12345678\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'女\',`marry` = \'未\',`blood` = \'A\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-16\',`bornday2` = \'1991-01-16\',`email` = \'gmail@gmail.com\',`address` = \'台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'B\',`presentname` = \'B1\',`workday` = \'85-01-01\',`workday2` = \'1996-01-01\',`expireday` = \'80-01-01\',`expireday2` = \'1991-01-01\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'台中市西屯區中工二路120號\',`add2` = \'台中市西屯區中工二路120號\',`buildday` = \'11303-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'3\';', 'UPDATE', '/jp/web_post.php'),
(637, '2024-03-07 16:30:50', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'B111\',`employname` = \'張先生\',`no` = \'TEST\',`id` = \'A12345678\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'女\',`marry` = \'未\',`blood` = \'A\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-16\',`bornday2` = \'1991-01-16\',`email` = \'gmail@gmail.com\',`address` = \'台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'B\',`presentname` = \'B1\',`workday` = \'85-01-01\',`workday2` = \'1996-01-01\',`expireday` = \'\',`expireday2` = \'1911--\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'台中市西屯區中工二路120號\',`add2` = \'台中市西屯區中工二路120號\',`buildday` = \'11303-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'3\';', 'UPDATE', '/jp/web_post.php'),
(638, '2024-03-07 16:35:02', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'B111\',`employname` = \'張先生\',`no` = \'TEST\',`id` = \'A12345678\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'女\',`marry` = \'未\',`blood` = \'A\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-16\',`bornday2` = \'1991-01-16\',`email` = \'gmail@gmail.com\',`address` = \'台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'B\',`presentname` = \'B1\',`workday` = \'85-01-01\',`workday2` = \'1996-01-01\',`expireday` = \'\',`expireday2` = \'1911--\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'台中市西屯區中工二路120號\',`add2` = \'台中市西屯區中工二路120號\',`buildday` = \'11303-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'3\';', 'UPDATE', '/jp/web_post.php'),
(639, '2024-03-07 16:35:07', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'B111\',`employname` = \'張先生\',`no` = \'TEST\',`id` = \'A12345678\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'女\',`marry` = \'未\',`blood` = \'A\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-16\',`bornday2` = \'1991-01-16\',`email` = \'gmail@gmail.com\',`address` = \'台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'B\',`presentname` = \'B1\',`workday` = \'85-01-01\',`workday2` = \'1996-01-01\',`expireday` = \'80-01-01\',`expireday2` = \'1991-01-01\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'台中市西屯區中工二路120號\',`add2` = \'台中市西屯區中工二路120號\',`buildday` = \'11303-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'3\';', 'UPDATE', '/jp/web_post.php'),
(640, '2024-03-07 16:35:12', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'B111\',`employname` = \'張先生\',`no` = \'TEST\',`id` = \'A12345678\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'女\',`marry` = \'未\',`blood` = \'A\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-16\',`bornday2` = \'1991-01-16\',`email` = \'gmail@gmail.com\',`address` = \'台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'B\',`presentname` = \'B1\',`workday` = \'85-01-01\',`workday2` = \'1996-01-01\',`expireday` = \'80-02-01\',`expireday2` = \'1991-02-01\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'台中市西屯區中工二路120號\',`add2` = \'台中市西屯區中工二路120號\',`buildday` = \'11303-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'3\';', 'UPDATE', '/jp/web_post.php'),
(641, '2024-03-07 16:35:17', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'B111\',`employname` = \'張先生\',`no` = \'TEST\',`id` = \'A12345678\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'女\',`marry` = \'未\',`blood` = \'A\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-16\',`bornday2` = \'1991-01-16\',`email` = \'gmail@gmail.com\',`address` = \'台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'B\',`presentname` = \'B1\',`workday` = \'85-01-01\',`workday2` = \'1996-01-01\',`expireday` = \'\',`expireday2` = \'1911--\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'台中市西屯區中工二路120號\',`add2` = \'台中市西屯區中工二路120號\',`buildday` = \'11303-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'3\';', 'UPDATE', '/jp/web_post.php'),
(642, '2024-03-07 16:49:35', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'B111\',\'陳小姐\',\'A001\',\'A123456\',\'ZHANG,XIAN-SHENG\',\'女\',\'未\',\'O\',\'台灣\',\'台中市\',\'90-03-08\',\'2001-03-08\',\'gmail@gmail.com\',\'407台中市西屯區中工二路120號\',\'\',\'\',\'\',\'WD\',\'網設部\',\'BE\',\'後端工程師\',\'D\',\'D1\',\'80-01-01\',\'1991-01-01\',\'80-06-06\',\'1991-06-06\',\'張太太\',\'妻子\',\'0912345678\',\'0912345678\',\'407台中市西屯區中工二路120號\',\'test\',\'407台中市西屯區中工二路120號\',\'407台中市西屯區中工二路120號\',\'11303-07\',\'2024-03-07\');', 'INSERT', '/jp/web_post.php'),
(643, '2024-03-07 16:50:04', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'B111\',\'陳小姐\',\'TEST\',\'123\',\'\',\'\',\'\',\'O\',\'\',\'\',\'80-01-01\',\'1991-01-01\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'80-01-01\',\'1991-01-01\',\'\',\'1911--\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'11303-07\',\'2024-03-07\');', 'INSERT', '/jp/web_post.php'),
(644, '2024-03-07 16:50:12', '系統管理員', '1', '', 'DELETE FROM employee  WHERE employid = \'B111\';', 'DELETE', '/jp/web_post.php'),
(645, '2024-03-07 16:51:52', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'B111\',\'陳小姐\',\'TEST\',\'A123456\',\'ZHANG,XIAN-SHENG\',\'女\',\'未\',\'B\',\'台灣\',\'台中市\',\'80-01-01\',\'1991-01-01\',\'gmail@gmail.com\',\'407台中市西屯區中工二路120號\',\'0912345678\',\'0412345678\',\'0912345678\',\'WD\',\'網設部\',\'BE\',\'後端工程師\',\'G\',\'G1\',\'80-01-01\',\'1991-01-01\',\'\',\'1911--\',\'張太太\',\'妻子\',\'0912345678\',\'0912345678\',\'407台中市西屯區中工二路120號\',\'test\',\'407台中市西屯區中工二路120號\',\'407台中市西屯區中工二路120號\',\'11303-07\',\'2024-03-07\');', 'INSERT', '/jp/web_post.php'),
(646, '2024-03-07 16:57:51', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'A111\',\'張先生\',\'A001\',\'A123456\',\'ZHANG,XIAN-SHENG\',\'男\',\'已\',\'AB\',\'台灣\',\'台中市\',\'80-01-01\',\'1991-01-01\',\'g@gmail.com\',\'407台中市西屯區中工二路120號\',\'0512345678\',\'0412345678\',\'0912345678\',\'WD\',\'網設部\',\'\',\'\',\'G\',\'G1\',\'80-01-01\',\'1991-01-01\',\'\',\'1911--\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'11303-07\',\'2024-03-07\');', 'INSERT', '/jp/web_post.php'),
(647, '2024-03-07 16:58:17', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'A111\',`employname` = \'張先生\',`no` = \'A001\',`id` = \'A123456\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'男\',`marry` = \'已\',`blood` = \'AB\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-01\',`bornday2` = \'1991-01-01\',`email` = \'g@gmail.com\',`address` = \'407台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'\',`appname` = \'\',`presenttype` = \'G\',`presentname` = \'G1\',`workday` = \'80-01-01\',`workday2` = \'1991-01-01\',`expireday` = \'\',`expireday2` = \'1911--\',`contact` = \'\',`contactrelation` = \'\',`contacttel1` = \'\',`contacttel2` = \'\',`contactadd` = \'\',`pro` = \'\',`add1` = \'\',`add2` = \'\',`buildday` = \'11303-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'7\';', 'UPDATE', '/jp/web_post.php'),
(648, '2024-03-07 16:58:38', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'A111\',`employname` = \'張先生\',`no` = \'A001\',`id` = \'A123456\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'男\',`marry` = \'已\',`blood` = \'AB\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-01\',`bornday2` = \'1991-01-01\',`email` = \'g@gmail.com\',`address` = \'407台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'G\',`presentname` = \'G1\',`workday` = \'80-01-01\',`workday2` = \'1991-01-01\',`expireday` = \'\',`expireday2` = \'1911--\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'407台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'407台中市西屯區中工二路120號\',`add2` = \'407台中市西屯區中工二路120號\',`buildday` = \'11303-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'7\';', 'UPDATE', '/jp/web_post.php'),
(649, '2024-03-07 17:19:08', '系統管理員', '1', '', 'INSERT INTO employee (`cono`,`coname1`,`employid`,`employname`,`no`,`id`,`EngName`,`sex`,`marry`,`blood`,`nationality`,`born`,`bornday`,`bornday2`,`email`,`address`,`tel`,`fax`,`mphone`,`partno`,`partname`,`appno`,`appname`,`presenttype`,`presentname`,`workday`,`workday2`,`expireday`,`expireday2`,`contact`,`contactrelation`,`contacttel1`,`contacttel2`,`contactadd`,`pro`,`add1`,`add2`,`buildday`,`buildday2`) VALUES (\'01\',\'庫點子\',\'C111\',\'豬大仙\',\'C001\',\'A12345678\',\'ZHANG,XIAN-SHENG\',\'女\',\'未\',\'B\',\'台灣\',\'台中市\',\'102-07-18\',\'2013-07-18\',\'gmail@gmail.com\',\'407台中市西屯區中工二路120號\',\'0912345678\',\'0412345678\',\'0912345678\',\'\',\'\',\'\',\'\',\'\',\'\',\'80-01-01\',\'1991-01-01\',\'\',\'1911--\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'\',\'113-03-07\',\'2024-03-07\');', 'INSERT', '/jp/web_post.php'),
(650, '2024-03-07 17:19:30', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'C111\',`employname` = \'豬大仙\',`no` = \'C001\',`id` = \'A12345678\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'女\',`marry` = \'未\',`blood` = \'B\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'102-07-18\',`bornday2` = \'2013-07-18\',`email` = \'gmail@gmail.com\',`address` = \'407台中市西屯區中工二路120號\',`tel` = \'0912345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'B\',`presentname` = \'B1\',`workday` = \'80-01-01\',`workday2` = \'1991-01-01\',`expireday` = \'\',`expireday2` = \'1911--\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'407台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'407台中市西屯區中工二路120號\',`add2` = \'407台中市西屯區中工二路120號\',`buildday` = \'113-03-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(651, '2024-03-08 08:55:59', '', '', '', 'UPDATE web_company SET `Company_PW` = \'767f2e385cba483c5e3a0f41d9d78cc3\',`Company_RePwd` = \'\',`Company_Is_RePwd` = \'0\'  WHERE (BINARY Company_Acc = \'JBS123\' OR BINARY Company_Email = \'JBS123\') AND (BINARY Company_PW = \'767f2e385cba483c5e3a0f41d9d78cc3\' OR BINARY Company_RePwd = \'767f2e385cba483c5e3a0f41d9d78cc3\');', 'UPDATE', '/jp/web_post.php'),
(652, '2024-03-08 09:05:39', '', '', '', 'UPDATE sys_admin SET `Admin_Code` = \'90fedbf99d3dc74c77fc9707bb59a2d2\',`Admin_LastLogin` = NOW(),`Admin_IP` = \'61.218.134.131\'  WHERE Admin_ID = \'1\';', 'UPDATE', '/jp/system/post/SPOST_Login.php'),
(653, '2024-03-08 15:14:29', '系統管理員', '1', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'A111\',`employname` = \'張先生\',`no` = \'A001\',`id` = \'A123456\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'男\',`marry` = \'已\',`blood` = \'AB\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-01\',`bornday2` = \'1991-01-01\',`email` = \'g@gmail.com\',`address` = \'407台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'G\',`presentname` = \'G1\',`workday` = \'80-01-01\',`workday2` = \'1991-01-01\',`expireday` = \'\',`expireday2` = \'1911--\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'407台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'407台中市西屯區中工二路120號\',`add2` = \'407台中市西屯區中工二路120號\',`buildday` = \'113-03-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'7\';', 'UPDATE', '/jp/web_post.php'),
(654, '2024-03-08 17:51:24', '系統管理員', '1', '', 'UPDATE employee SET `sandtype` = \'1\',`standardday` = \'30\',`standardhour` = \'8\',`monthmny` = \'30000\',`daymny` = \'1000\',`hourmny` = \'125\',`taxmny` = \'123\',`starttype` = \'0\',`resttype` = \'0\',`bankno` = \'021\',`bankno2` = \'052\',`bankname` = \'花旗銀行\',`bankname2` = \'渣打國際商業銀行\',`huming` = \'test\',`huming2` = \'test2\',`bankid` = \'123\',`bankid2` = \'321\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(655, '2024-03-11 08:55:40', '', '', '', 'UPDATE web_company SET `Company_PW` = \'767f2e385cba483c5e3a0f41d9d78cc3\',`Company_RePwd` = \'\',`Company_Is_RePwd` = \'0\'  WHERE (BINARY Company_Acc = \'JBS123\' OR BINARY Company_Email = \'JBS123\') AND (BINARY Company_PW = \'767f2e385cba483c5e3a0f41d9d78cc3\' OR BINARY Company_RePwd = \'767f2e385cba483c5e3a0f41d9d78cc3\');', 'UPDATE', '/jp/web_post.php'),
(656, '2024-03-11 09:55:00', '', '', '', 'UPDATE employee SET `sandtype` = \'1\',`standardday` = \'30\',`standardhour` = \'8\',`monthmny` = \'30000\',`daymny` = \'1000\',`hourmny` = \'125\',`taxmny` = \'123\',`starttype` = \'0\',`resttype` = \'0\',`bankno` = \'021\',`bankno2` = \'052\',`bankname` = \'花旗銀行\',`bankname2` = \'渣打國際商業銀行\',`huming` = \'test\',`huming2` = \'test2\',`bankid` = \'123\',`bankid2` = \'321\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(657, '2024-03-11 09:55:13', '', '', '', 'UPDATE employee SET `sandtype` = \'2\',`standardday` = \'30\',`standardhour` = \'8\',`monthmny` = \'30000\',`daymny` = \'1000\',`hourmny` = \'125\',`taxmny` = \'123\',`starttype` = \'1\',`resttype` = \'1\',`bankno` = \'021\',`bankno2` = \'052\',`bankname` = \'花旗銀行\',`bankname2` = \'渣打國際商業銀行\',`huming` = \'test\',`huming2` = \'test2\',`bankid` = \'123\',`bankid2` = \'321\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(658, '2024-03-11 09:56:56', '', '', '', 'UPDATE employee SET `sandtype` = \'3\',`standardday` = \'30\',`standardhour` = \'8\',`monthmny` = \'30000\',`daymny` = \'1000\',`hourmny` = \'125\',`taxmny` = \'123\',`starttype` = \'1\',`resttype` = \'1\',`bankno` = \'021\',`bankno2` = \'052\',`bankname` = \'花旗銀行\',`bankname2` = \'渣打國際商業銀行\',`huming` = \'test\',`huming2` = \'test2\',`bankid` = \'123\',`bankid2` = \'321\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(659, '2024-03-11 09:57:31', '', '', '', 'UPDATE employee SET `sandtype` = \'3\',`standardday` = \'25\',`standardhour` = \'4\',`monthmny` = \'30000\',`daymny` = \'1200\',`hourmny` = \'300\',`taxmny` = \'123\',`starttype` = \'1\',`resttype` = \'1\',`bankno` = \'021\',`bankno2` = \'052\',`bankname` = \'花旗銀行\',`bankname2` = \'渣打國際商業銀行\',`huming` = \'test\',`huming2` = \'test2\',`bankid` = \'123\',`bankid2` = \'321\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(660, '2024-03-11 09:59:39', '', '', '', 'UPDATE employee SET `sandtype` = \'3\',`standardday` = \'25\',`standardhour` = \'4\',`monthmny` = \'30000\',`daymny` = \'1200\',`hourmny` = \'300\',`taxmny` = \'123\',`starttype` = \'0\',`resttype` = \'0\',`bankno` = \'021\',`bankno2` = \'052\',`bankname` = \'花旗銀行\',`bankname2` = \'渣打國際商業銀行\',`huming` = \'test\',`huming2` = \'test2\',`bankid` = \'123\',`bankid2` = \'321\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(661, '2024-03-11 10:02:11', '', '', '', 'UPDATE employee SET `sandtype` = \'3\',`standardday` = \'25\',`standardhour` = \'4\',`monthmny` = \'30000\',`daymny` = \'1200\',`hourmny` = \'300\',`taxmny` = \'123\',`starttype` = \'1\',`resttype` = \'0\',`bankno` = \'021\',`bankno2` = \'052\',`bankname` = \'花旗銀行\',`bankname2` = \'渣打國際商業銀行\',`huming` = \'test\',`huming2` = \'test2\',`bankid` = \'123\',`bankid2` = \'321\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(662, '2024-03-11 10:02:43', '', '', '', 'UPDATE sys_admin SET `Admin_Code` = \'cf2611d1ea914ccff7029218eb07f217\',`Admin_LastLogin` = NOW(),`Admin_IP` = \'61.218.134.131\'  WHERE Admin_ID = \'1\';', 'UPDATE', '/jp/system/post/SPOST_Login.php'),
(663, '2024-03-11 10:03:44', '系統管理員', '1', '', 'UPDATE employee SET `sandtype` = \'3\',`standardday` = \'25\',`standardhour` = \'4\',`monthmny` = \'30000\',`daymny` = \'1200\',`hourmny` = \'300\',`taxmny` = \'123\',`starttype` = \'0\',`resttype` = \'0\',`bankno` = \'001\',`bankno2` = \'048\',`bankname` = \'中央信託局\',`bankname2` = \'臺灣工業銀行\',`huming` = \'test\',`huming2` = \'test2\',`bankid` = \'123\',`bankid2` = \'321\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(664, '2024-03-11 10:04:40', '系統管理員', '1', '', 'UPDATE employee SET `sandtype` = \'3\',`standardday` = \'25\',`standardhour` = \'4\',`monthmny` = \'30000\',`daymny` = \'1200\',`hourmny` = \'300\',`taxmny` = \'123\',`starttype` = \'0\',`resttype` = \'0\',`bankno` = \'001\',`bankno2` = \'048\',`bankname` = \'中央信託局\',`bankname2` = \'臺灣工業銀行\',`huming` = \'test\',`huming2` = \'test2\',`bankid` = \'123\',`bankid2` = \'321\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
...
(678, '2024-03-12 13:42:57', '', '', '', 'UPDATE employee SET `overtimetype` = \'0\',`overtimemnytype` = \'3\',`normalovertimemny` = \'0\',`normalovertimerate` = \'1.34\',`extendovertimemny` = \'0\',`extendovertimerate` = \'1.67\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'2\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'2\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'1.34\',`resthourrate2` = \'1.67\',`resthourrate3` = \'2.67\',`otway` = \'1\',`jiabanbudadan` = \'0\',`overtime` = \'\',`jiabanbudashi` = \'0\',`mealflag` = \'0\',`mealmny` = \'0\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(679, '2024-03-12 13:46:06', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'1\',`normalovertimemny` = \'200\',`normalovertimerate` = \'0\',`extendovertimemny` = \'200\',`extendovertimerate` = \'0\',`holidayovertimemny` = \'300\',`holidayovertimerate` = \'0\',`publicholidayovertimemny` = \'1000\',`publicholidayovertimerate` = \'0\',`restovertimemny1` = \'2000\',`restovertimemny2` = \'2000\',`restovertimemny3` = \'1234\',`resthourrate1` = \'0\',`resthourrate2` = \'0\',`resthourrate3` = \'0\',`otway` = \'1\',`jiabanbudadan` = \'1\',`overtime` = \'1\',`jiabanbudashi` = \'1\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(680, '2024-03-12 13:48:55', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'2\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'0\',`overtime` = \'1\',`jiabanbudashi` = \'\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(681, '2024-03-12 13:49:33', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'2\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'1\',`overtime` = \'2\',`jiabanbudashi` = \'1\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(682, '2024-03-12 13:50:03', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'2\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'0\',`overtime` = \'\',`jiabanbudashi` = \'0\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(683, '2024-03-12 13:52:01', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'2\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'1\',`overtime` = \'\',`jiabanbudashi` = \'1\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(684, '2024-03-12 13:52:33', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'2\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'0\',`overtime` = \'\',`jiabanbudashi` = \'0\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(685, '2024-03-12 14:00:41', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'2\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'1\',`overtime` = \'1\',`jiabanbudashi` = \'1\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(686, '2024-03-12 14:00:58', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'2\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'1\',`overtime` = \'1\',`jiabanbudashi` = \'1\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(687, '2024-03-12 14:03:16', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'2\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'1\',`overtime` = \'2\',`jiabanbudashi` = \'1\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(688, '2024-03-12 14:03:24', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'2\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'0\',`overtime` = \'\',`jiabanbudashi` = \'0\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(689, '2024-03-12 14:04:03', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'2\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'1\',`jiabanbudadan` = \'0\',`overtime` = \'\',`jiabanbudashi` = \'0\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(690, '2024-03-12 14:04:17', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'2\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'1\',`jiabanbudadan` = \'1\',`overtime` = \'1\',`jiabanbudashi` = \'1\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(691, '2024-03-12 14:29:24', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'3\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'1\',`jiabanbudadan` = \'0\',`overtime` = \'\',`jiabanbudashi` = \'0\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(692, '2024-03-12 14:29:33', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'3\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'1\',`jiabanbudadan` = \'1\',`overtime` = \'1\',`jiabanbudashi` = \'1000\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(693, '2024-03-12 14:29:45', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'3\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'0\',`overtime` = \'2\',`jiabanbudashi` = \'0\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(694, '2024-03-12 14:32:35', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'3\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'0\',`overtime` = \'1\',`jiabanbudashi` = \'10\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
(695, '2024-03-12 14:32:43', '', '', '', 'UPDATE employee SET `overtimetype` = \'1\',`overtimemnytype` = \'3\',`normalovertimemny` = \'0\',`normalovertimerate` = \'10\',`extendovertimemny` = \'0\',`extendovertimerate` = \'20\',`holidayovertimemny` = \'0\',`holidayovertimerate` = \'30\',`publicholidayovertimemny` = \'0\',`publicholidayovertimerate` = \'40\',`restovertimemny1` = \'0\',`restovertimemny2` = \'0\',`restovertimemny3` = \'0\',`resthourrate1` = \'50\',`resthourrate2` = \'60\',`resthourrate3` = \'70\',`otway` = \'2\',`jiabanbudadan` = \'0\',`overtime` = \'2\',`jiabanbudashi` = \'0\',`mealflag` = \'1\',`mealmny` = \'1230\'  WHERE  eid = \'8\';', 'UPDATE', '/jp/web_post.php'),
...
(724, '2024-03-14 11:49:13', '', '', '', 'UPDATE employee SET `cono` = \'01\',`coname1` = \'庫點子\',`employid` = \'A111\',`employname` = \'張先生\',`no` = \'A001\',`id` = \'A123456\',`EngName` = \'ZHANG,XIAN-SHENG\',`sex` = \'男\',`marry` = \'已\',`blood` = \'AB\',`nationality` = \'台灣\',`born` = \'台中市\',`bornday` = \'80-01-01\',`bornday2` = \'1991-01-01\',`email` = \'g@gmail.com\',`address` = \'407台中市西屯區中工二路120號\',`tel` = \'0512345678\',`fax` = \'0412345678\',`mphone` = \'0912345678\',`partno` = \'WD\',`partname` = \'網設部\',`appno` = \'BE\',`appname` = \'後端工程師\',`presenttype` = \'G\',`presentname` = \'G1\',`workday` = \'86-07-16\',`workday2` = \'1997-07-16\',`expireday` = \'\',`expireday2` = \'1911--\',`contact` = \'張太太\',`contactrelation` = \'妻子\',`contacttel1` = \'0912345678\',`contacttel2` = \'0912345678\',`contactadd` = \'407台中市西屯區中工二路120號\',`pro` = \'test\',`add1` = \'407台中市西屯區中工二路120號\',`add2` = \'407台中市西屯區中工二路120號\',`buildday` = \'113-03-07\',`buildday2` = \'2024-03-07\'  WHERE  eid = \'7\';', 'UPDATE', '/jp/web_post.php'),
(725, '2024-03-14 11:58:56', '', '', '', 'UPDATE employee SET `sandtype` = \'2\',`standardday` = \'30\',`standardhour` = \'8\',`monthmny` = \'0\',`daymny` = \'5000\',`hourmny` = \'625\',`taxmny` = \'110\',`starttype` = \'0\',`resttype` = \'1\',`bankno` = \'052\',`bankno2` = \'\',`bankname` = \'渣打國際商業銀行\',`bankname2` = \'\',`huming` = \'渣打國際\',`huming2` = \'測試\',`bankid` = \'012345678\',`bankid2` = \'01234\'  WHERE  eid = \'7\';', 'UPDATE', '/jp/web_post.php'),
(726, '2024-03-14 11:59:44', '', '', '', 'UPDATE employee SET `overtimetype` = \'0\',`overtimemnytype` = \'1\',`normalovertimemny` = \'200\',`normalovertimerate` = \'0\',`extendovertimemny` = \'300\',`extendovertimerate` = \'0\',`holidayovertimemny` = \'400\',`holidayovertimerate` = \'0\',`publicholidayovertimemny` = \'500\',`publicholidayovertimerate` = \'0\',`restovertimemny1` = \'600\',`restovertimemny2` = \'700\',`restovertimemny3` = \'800\',`resthourrate1` = \'0\',`resthourrate2` = \'0\',`resthourrate3` = \'0\',`otway` = \'2\',`jiabanbudadan` = \'0\',`overtime` = \'1\',`jiabanbudashi` = \'100\',`mealflag` = \'1\',`mealmny` = \'50\'  WHERE  eid = \'7\';', 'UPDATE', '/jp/web_post.php'),
